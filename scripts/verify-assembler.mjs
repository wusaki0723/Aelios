 ...
 * (BLOCK_ORDER, text literals, simpleHash) MUST
...
check("queue: consumer handles memory_maintenance via runMemoryMaintenance", () => {
  // Contract: handleQueueMessage for memory_maintenance calls runMemoryMaintenance only.
